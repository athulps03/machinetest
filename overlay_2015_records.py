#Overlay a scatter of the 2015 data for any points (highs and lows) for which the ten year record (2005-2014) record high or 
...
# Format the plot
plt.title('Record High and Low Temperatures by Day of Year (2005-2014) with 2015 Records Broken')
...
plt.savefig('plot_with_2015_breaks.png')  # Save as an image file
